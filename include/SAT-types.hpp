...
namespace napsat
{
  ...
  typedef struct Tlevel {
    ...
    inline Tlevel operator++(int) { Tlevel tmp = *this; value++; return tmp; }
    inline void operator--() { value--; }
    inline Tlevel operator--(int) { Tlevel tmp = *this; value--; return tmp; }
...
namespace std {
  template <>
  struct hash<napsat::Tclause> {
      std::size_t operator()(const napsat::Tclause& cl) const {
          return cl.hash();
      }
  };

  // define to to_string for Tvar, Tlit, Tlevel, Tclause
  inline std::string to_string(const napsat::Tvar& var) {
      return var.to_string();
  }
  inline std::string to_string(const napsat::Tlit& lit) {
      return lit.to_string();
  }
  inline std::string to_string(const napsat::Tlevel& level) {
      return level.to_string();
  }
  inline std::string to_string(const napsat::Tclause& cl) {
      return cl.to_string();
  }

  // define operator<< for Tvar, Tlit, Tlevel, Tclause
  inline std::ostream& operator<<(std::ostream& os, const napsat::Tvar& var) {
      return os << var.to_string();
  }
  inline std::ostream& operator<<(std::ostream& os, const napsat::Tlit& lit) {
      return os << lit.to_string();
  }
  inline std::ostream& operator<<(std::ostream& os, const napsat::Tlevel& level) {
      return os << level.to_string();
  }
  inline std::ostream& operator<<(std::ostream& os, const napsat::Tclause& cl) {
