...
unsigned sat::gui::new_variable::get_event_level(observer& observer)
{
  return observer.is_variable_marked(var) ? 0 : event_level;
}
...
unsigned sat::gui::delete_variable::get_event_level(observer& observer)
{
  return observer.is_variable_marked(var) ? 0 : event_level;
}
...
unsigned sat::gui::decision::get_event_level(observer& observer)
{
  return observer.is_variable_marked(lit_to_var(lit)) ? 0 : event_level;
}
...
unsigned sat::gui::implication::get_event_level(observer& observer)
{
  return observer.is_variable_marked(lit_to_var(lit)) || observer.is_clause_marked(reason) ? 0 : event_level;
}
...
unsigned sat::gui::propagation::get_event_level(observer& observer)
{
  return observer.is_variable_marked(lit_to_var(lit)) ? 0 : event_level;
}
...
unsigned sat::gui::unassignment::get_event_level(observer& observer)
{
  return observer.is_variable_marked(lit_to_var(lit)) ? 0 : event_level;
}
...
unsigned sat::gui::new_clause::get_event_level(observer& observer)
{
  return observer.is_clause_marked(cl) ? 0 : event_level;
}
...
unsigned sat::gui::delete_clause::get_event_level(observer& observer)
{
  return observer.is_clause_marked(cl) ? 0 : event_level;
}
...
unsigned sat::gui::conflict::get_event_level(observer& observer)
{
  return observer.is_clause_marked(cl) ? 0 : event_level;
}
...
unsigned sat::gui::watch::get_event_level(observer& observer)
{
...
unsigned sat::gui::unwatch::get_event_level(observer& observer)
{
  return observer.is_variable_marked(lit_to_var(lit)) || observer.is_clause_marked(cl) ? 0 : event_level;
}
...
unsigned sat::gui::remove_literal::get_event_level(observer& observer)
{
  return observer.is_variable_marked(lit_to_var(lit)) || observer.is_clause_marked(cl) ? 0 : event_level;
}
